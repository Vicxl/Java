...
import java.util.logging.SocketHandler;r
...
public final class FileUtil {
    ...
    public static boolean isWindows() {
        File file = new File("E:" + File.separator + "workspace");
        if(file.separator == ";"){//条件错误
            System.out.println("此为Windows环境");
            return true;
        }else
            if(file.separator == ":"){
            System.out.println("该环境不是Windows环境");
            return false;
        }
    }
